...
public abstract class CuerpoCeleste extends BranchGroup {
    ...
    public CuerpoCeleste(long vr, long vt, float d, float rdistancia, String textura){
        ...
        app.setMaterial(new Material(new Color3f (0.4f, 0.4f, 0.4f), new Color3f (0.0f, 0.0f, 0.0f),
        new Color3f (0.9f, 0.9f, 0.9f), new Color3f (0.4f, 0.4f, 0.4f), 17.0f)) ; 
    ...
    protected abstract void crearDistancia() ;
