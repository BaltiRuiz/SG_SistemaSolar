...
public class SistemaSolarSG {
    ...
    public SistemaSolarSG() {
        ...
        createViewPlanta() ;
        Visualization visualizationfija = new Visualization("Sistema Solar: Vista en planta", 550, 700, 50, 0, canvasfijo) ;
        ...
        Visualization visualizationcambiante = new Visualization("Sistema Solar: Vista cambiante", 500, 500, 850, 100, canvascambiante) ;
        ...
        ParadaAstro paradaastro = createPick() ;
        raiz.addChild(paradaastro) ;
    ...
    private void createViewPlanta(){
        ...
        transformPlanta.lookAt (new Point3d (0, 550, 0), new Point3d (0, 0, 0), new Vector3d (1, 0, 0)) ;
    ...
    private BranchGroup createScene() {
        ...
        Anillo anillo1 = new Anillo(14, 18, 100, "imgs/Anillo.jpg") ;
        Anillo anillo2 = new Anillo(20, 22, 100, "imgs/Anillo.jpg") ;
        Anillo anillo3 = new Anillo(24, 28, 100, "imgs/Anillo.jpg") ;
        ...
        Satelite triton = new Satelite(6000, 6000, 2, 11, "imgs/Triton.jpg", null) ;
    ...
    private ParadaAstro createPick(){
        ParadaAstro paradaastro = new ParadaAstro(canvasfijo, raiz) ;
        paradaastro.setSchedulingBounds(new BoundingSphere(new Point3d(0.0, 0.0, 0.0), 100000.0)) ;
